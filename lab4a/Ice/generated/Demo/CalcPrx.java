...
public interface CalcPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    default float avg(long[] arr)
        throws NoInput
    {
        return avg(arr, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default float avg(long[] arr, java.util.Map<String, String> context)
        throws NoInput
    {
        try
        {
    ...
    default java.util.concurrent.CompletableFuture<java.lang.Float> avgAsync(long[] arr)
    {
        return _iceI_avgAsync(arr, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.Float> avgAsync(long[] arr, java.util.Map<String, String> context)
    {
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.Float> _iceI_avgAsync(long[] iceP_arr, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<java.lang.Float> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "avg", com.zeroc.Ice.OperationMode.Idempotent, sync, _iceE_avg);
        f.invoke(true, context, null, ostr -> {
