...
public class ThriftClient 
{
	public static void main(String [] args) 
	{
		...
		SortingMachine.Client synSortingMachine = null;
...
//				protocol = new TCompactProtocol(transport);
				...
				synSortingMachine = new SortingMachine.Client(protocol);
			}
			else if(opt.contains("multiplex"))
			{
				...
				synSortingMachine = new SortingMachine.Client(new TMultiplexedProtocol(protocol, "M1"));
			}
			...
			do
			{
				try
				{
					...
					{
						List<Integer> nums = new ArrayList<>(Arrays.asList(1, 2, 5, -5, 16, 22, 7, 4, 12));
						nums = synSortingMachine.sortNumbers(nums);
