...
//			Calculator.Processor<CalculatorHandler> processor2 = new Calculator.Processor<CalculatorHandler>(new CalculatorHandler(2));
	...
	public static void multiplex() 
	{
		try {
			...
			SortingMachine.Processor<SortingMachineHandler> processor5 = new SortingMachine.Processor<SortingMachineHandler>(new SortingMachineHandler(31));
			...
			multiplex.registerProcessor("M1", processor5);
